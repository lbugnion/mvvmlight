...
namespace GalaSoft.MvvmLight.Helpers
{
    public class Binding<TProperty>
    {
        ...
        public Binding(
            ...
            : this(source, sourcePropertyName, source, targetPropertyName, mode)
        {
        }
        ...
        public Binding(
            ...
            Expression<Func<TProperty>> targetPropertyExpression,
            BindingMode mode = BindingMode.Default)
            : this(source, sourcePropertyExpression, source, targetPropertyExpression, mode)
        {
        }
