...
using ProjectForTemplateSL.Model;
using ProjectForTemplateSL.Properties;
...
namespace ProjectForTemplateSL.ViewModel
{
    ...
    public class MainViewModel : ViewModelBase
    {
        ...
        public MainViewModel()
        {
            ...
            Messenger.Default.Register<PropertyChangedMessageBase>(this, true, HandlePropertyChangedMessage);
        }
        ...
        private void HandlePropertyChangedMessage(PropertyChangedMessageBase message)
        {
